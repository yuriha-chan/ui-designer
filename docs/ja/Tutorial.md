...
![エンティティ追加ボタンの位置](screenshots/final/step1-02.png)

![エンティティが追加された状態](screenshots/final/step1-03.png)

![エンティティ名入力中](screenshots/final/step1-04.png)

![エンティティ名「本」が確定した状態](screenshots/final/step1-05.png)

次に、このエンティティの持つ情報を定義します。エンティティ名の右にある「+」ボタンをクリックし、最初の項目を「タイトル」とします。型は `string`、つまり文字列です。

![プロパティ追加ボタンの位置](screenshots/final/step1-06.png)

![プロパティ名入力中](screenshots/final/step1-07.png)

![タイトルプロパティ確定後](screenshots/final/step1-08.png)

もう一度「+」をクリックし、「価格」と入力します。こちらは型を `number` に変更します。

![価格プロパティ名入力中](screenshots/final/step1-09.png)

![型ドロップダウン](screenshots/final/step1-10.png)

![number型選択中](screenshots/final/step1-11.png)

これで「本」というエンティティが定義されたことになります。

同様に「顧客」というエンティティも作成し、「名前」と「住所」という2つの文字列プロパティを持たせます。

![第二エンティティ追加ボタン](screenshots/final/step1-13.png)

![顧客エンティティ完了状態](screenshots/final/step1-14.png)
...
![画面タブの位置](screenshots/final/step2-01.png)

![画面タブ選択後](screenshots/final/step2-02.png)

![画面名入力欄](screenshots/final/step2-03.png)

![販売画面入力中](screenshots/final/step2-04.png)

![追加ボタン](screenshots/final/step2-05.png)

続けて「会計画面」「購入完了画面」も追加します。

![全画面追加後](screenshots/final/step2-06.png)

リストから「販売画面」を選択すると、左側の領域が「販売画面」の編集エリアになります。空白が表示されているはずです。

![販売画面選択後のキャンバス](screenshots/final/step2-07.png)
...
![コンテキストメニュー表示](screenshots/final/step3-01.png)

コンテナはグループ化のための箱、テキストは文字表示、数値は数値表示、ボタンはクリック可能な要素、入力は入力欄です。

1冊分の本の表示を作ってみます。

1. 右クリックして「コンテナ」を選択します。 ![コンテナ追加メニュー](screenshots/final/step3-02.png) ![コンテナ追加後](screenshots/final/step3-03.png)
2. 追加した**コンテナの中**を右クリックし、「テキスト」を選びます。 ![テキスト選択メニュー](screenshots/final/step3-05.png)
3. 「エンティティパス」というメニューが続けて表示されます。「エンティティパス」というのは、どのエンティティの、どのプロパティを表示するかを指定するものです。つまり、「このテキストコンポーネントは、どのデータを表示しますか？」と尋ねています。「本」を選び、展開されたリストから「タイトル」を選択します。 ![エンティティパス選択](screenshots/final/step3-06.png)
4. コンテナに「本 > タイトル」というコンポーネントが追加されました。 ![タイトル追加後](screenshots/final/step3-07.png)
5. コンテナの中の何もない余白を再度右クリックし、「数値」を選びます。次に「本」→「価格」を選択します。 ![価格追加後](screenshots/final/step3-09.png)
6. 最後に、コンテナに「ボタン」を追加し、ラベルとして「選択」を選びます。 ![ボタンラベル選択](screenshots/final/step3-11.png) ![ボタン追加後](screenshots/final/step3-12.png)
...
![コピーボタンの位置](screenshots/final/step3-13.png)

![コンテナ複製後](screenshots/final/step3-14.png)
...
![ボタンのドロップダウン位置](screenshots/final/step4-01.png)

![会計画面選択中](screenshots/final/step4-02.png)
...
![会計画面選択位置](screenshots/final/step5-01.png)

![会計画面編集完了](screenshots/final/step5-02.png)
...
![プレビューモード](screenshots/final/step6-02.png)

画面上部の「プレビューを終了」ボタンで、編集画面に戻ります。

![プレビュー終了ボタン](screenshots/final/step6-03.png)
...
![住所プロパティクリック位置](screenshots/final/step7-01.png)

![プロパティ名編集中](screenshots/final/step7-02.png)

![プロパティ名変更完了](screenshots/final/step7-03.png)

### Step 8: 画面名を変更する

画面の名前は、後から変更することもできます。画面上部のヘッダー部分をクリックことで、名前を編集できます。

![画面名ヘッダークリック位置](screenshots/final/step8-01.png)

![画面名編集中](screenshots/final/step8-02.png)

![画面名変更完了](screenshots/final/step8-03.png)
